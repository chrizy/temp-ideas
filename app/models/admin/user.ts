...
export const UserSchema = {
    ...
    fields: {
        ...
        restricted_to_specific_users: { type: "boolean" as const, label: "Restricted To Specific Users" },
        has_access_to_user_ids: { type: "string" as const, label: "Has Access To User IDs" }, // Comma separated list
